...
object HystrixMetricsStream extends Controller {
  ...
  private[this] final val maxConcurrentConnections: DynamicIntProperty = DynamicPropertyFactory.getInstance.getIntProperty("hystrix.stream.maxConcurrentConnections", 5)
